...
class CmImage extends _mjmlCore.BodyComponent {
  constructor(...args) {
    super(...args);

    _defineProperty(this, "headStyle", breakpoint => `
...
_defineProperty(CmImage, "allowedAttributes", {
  label: 'string',
  editable: 'string',
  alt: 'string',
  href: 'string',
...
_defineProperty(CmImage, "defaultAttributes", {
  editable: 'true',
  align: 'center',
  border: '0',
  height: 'auto',
